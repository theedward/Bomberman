...
import com.cmov.bomberman.controller.WifiP2PListener;
...
public class WifiBroadcastReceiver extends BroadcastReceiver{
    ...
    // create Listener
    public void setWifiP2PListener(WifiP2PListener listener) {
            ...
            if (manager != null) {
                manager.requestPeers(channel, new PeerListListener() {
                    ...
                    public void onPeersAvailable(WifiP2pDeviceList wifiP2pDeviceList) {
                        ...
                        wifiP2PListener.onUpdateListView(getGroupOwnersList(wifiP2pDeviceList));
                    }
                });
